...
export function ProductCard({ id, name, description, salePrice, costPrice, discountPercent, posterImage }) {
    return (
        <Flex key={id} p={50} w="full" alignItems="center" justifyContent="center">
            <Box
